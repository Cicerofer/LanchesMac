...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminPedidosController : Controller
    {
        ...
        {
            var resultado = _context.Pedidos.AsNoTracking() // As No Tracking as entidades não são rastreadas pelo contexto, assim o EF Core não realiza nenhum processamento adicional nas entidades
                                            .AsQueryable();// Ele converte a coleção para um tipo IQueryable
        ...
        // Para projetos contra ataques de postagem excessiva, habolite as propriedades específicas ás quais você deseja vincular..        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
