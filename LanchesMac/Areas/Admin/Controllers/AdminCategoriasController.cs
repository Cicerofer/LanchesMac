...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminCategoriasController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken] //BIND --> Este atributo vincula o valor especificado á implementação que foi configurada no seu container de injejçao de dependência.
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var categoria = await _context.Categorias.FindAsync(id);// Localiza na memória
            if (categoria == null)
            {
                return NotFound();
            }
